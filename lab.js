...
            statusSpan.style.color = 'blue';
            ...
            // Відправка даних на save_content.php (ваш save_c.php)
...
                    // Порівняння хешу даних для запобігання зайвому перерендерингу
...
                    itemDiv.classList.toggle('active');
                    ...
                    // ДОДАНО: Логіка розкриття/згортання через maxHeight
                    if (itemDiv.classList.contains('active')) {
                        // Встановлюємо висоту, необхідну для відображення всього вмісту
...
        fetchUpdates();
        [cite_start]// Періодичний асинхронний контроль змін кожні 3 секунди [cite: 16]
